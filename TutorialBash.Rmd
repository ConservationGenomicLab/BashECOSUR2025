...
##### **3.1 Conceptos importantes**  <a name="subparagraph3"></a> 
...
##### **3.2 Instalar MobaXterm**  <a name="subparagraph3"></a>  ![MobaXterm](Figuras/Mobaxterm1.png)

## 3.3 Cluster de supercómputo <a name="paragraph3"></a> 
...
## 3.4 Acceso a super cómputo por protocolo SSH <a name="paragraph3"></a>
...
##### 4.2 Introducción a GitHub <a name="subparagraph4"></a>    ![GitHub](Figuras/githubLogo.png){width='100px'}
...
***Ventajas:***  
![GitHub](Figuras/git_02.png)

## 4.3 Descargar material del curso con git <a name="subparagraph4"></a> 
En tu sesión del cluster "/home/user1/" copia y pega lo siguiente:

~~~   
usuario@sistema:~$ git clone https://github.com/ConservationGenomicLab/BashECOSUR2025.git  
~~~    

#### 4.4 Organización de directorios <a name="subparagraph4"></a> 
...
#### 4.5 Aprendiendo a usar comandos <a name="subparagraph4"></a> 
...
#### 4.6 Resumen <a name="subparagraph4"></a>   
...
#### 4.7 Primer quiz  <a name="subparagraph4"></a> 
...
#### 4.8 Práctica 1  <a name="subparagraph4"></a> 
